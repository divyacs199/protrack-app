    ...
    <div style={{ fontFamily: "sans-serif", maxWidth: 520, margin: "0 auto" }}>
      ...
      <div style={{ background: "white", borderRadius: 24, padding: 32, boxShadow: "0 2px 20px rgba(0,0,0,0.08)" }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: 28 }}>
          <div style={{ width: 80, height: 80, borderRadius: "50%", background: "linear-gradient(135deg,#667eea,#764ba2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 34, fontWeight: 900, color: "white", marginBottom: 14 }}>{user.name[0].toUpperCase()}</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 28, padding: "0 40px 40px", maxWidth: 1060, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14, paddingTop: 10 }}>
          ...
          <div style={{ background: "linear-gradient(135deg,rgba(102,126,234,0.3),rgba(118,75,162,0.3))", borderRadius: 18, padding: "18px 20px", border: "1px solid rgba(102,126,234,0.3)" }}>
            ...
            <p style={{ color: "white", fontSize: 13, lineHeight: 1.7, margin: 0 }}>One task. One screen. One goal. 🚀</p>
          </div>
        </div>
      </div>
...
function FeaturesPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg,#0f172a,#1e3a5f)", padding: "80px 24px 60px", fontFamily: "sans-serif" }}>
      <h1 style={{ color: "white", fontSize: 36, fontWeight: 800, textAlign: "center", marginBottom: 12 }}>Features</h1>
      <p style={{ color: "rgba(255,255,255,0.6)", textAlign: "center", fontSize: 16, marginBottom: 40 }}>Built for professionals · <span style={{ color: "#a5b4fc" }}>Tap any card to learn more</span></p>
        ...
        {features.map(function(f, idx) {
          return (
            <div key={f.title} onClick={function() { setSelectedIdx(idx); }}
              style={{ background: "rgba(255,255,255,0.06)", borderRadius: 20, padding: 24, border: "1px solid rgba(255,255,255,0.1)", cursor: "pointer", transition: "all .25s", position: "relative", overflow: "hidden" }}
              ...
              <h3 style={{ color: "white", fontSize: 17, marginBottom: 8, fontWeight: 800 }}>{f.title}</h3>
              <p style={{ color: "rgba(255,255,255,0.6)", fontSize: 14, lineHeight: 1.6, margin: "0 0 14px" }}>{f.desc}</p>
      ...
      {selected && (
        <div onClick={function() { setSelectedIdx(null); }} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", zIndex: 500, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
          <div onClick={function(e) { e.stopPropagation(); }} style={{ background: "#0f172a", borderRadius: 24, padding: 28, width: "100%", maxWidth: 520, border: "2px solid " + selected.color + "33", maxHeight: "90vh", overflowY: "auto" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{ width: 48, height: 48, borderRadius: 14, background: selected.color + "22", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24 }}>{selected.icon}</div>
                <div>
                  <h2 style={{ color: "white", fontSize: 20, fontWeight: 900, margin: 0 }}>{selected.title}</h2>
            ...
            <p style={{ color: "rgba(255,255,255,0.8)", fontSize: 14, lineHeight: 1.75, marginBottom: 20 }}>{selected.detail}</p>
...
function AboutPage() {
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg,#0f172a,#1e3a5f)", padding: "80px 24px", fontFamily: "sans-serif" }}>
      <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
        <div style={{ fontSize: 64, marginBottom: 20 }}>💼</div>
        <h1 style={{ color: "white", fontSize: 36, fontWeight: 800, marginBottom: 16 }}>About ProTrack</h1>
        <p style={{ color: "rgba(255,255,255,0.75)", fontSize: 16, lineHeight: 1.8, marginBottom: 36 }}>ProTrack helps working professionals stay on top of projects, skills, goals and deadlines — all in one clean dashboard.</p>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 16 }}>
          {[["🎯","Our Mission","Help professionals achieve more with less stress"],["💡","Our Vision","A world where every professional works at their best"],["❤️","Our Values","Clarity, focus and consistent execution"]].map(function(item) {
            return (
              <div key={item[1]} style={{ background: "rgba(255,255,255,0.06)", borderRadius: 16, padding: 20, border: "1px solid rgba(255,255,255,0.1)" }}>
                <div style={{ fontSize: 28, marginBottom: 10 }}>{item[0]}</div>
                <h3 style={{ color: "white", fontSize: 14, marginBottom: 8 }}>{item[1]}</h3>
...
export default function App() {
  ...
  // ── detect screen width ──
  const [isMobile, setIsMobile] = useState(function() { return window.innerWidth < 768; });
  useEffect(function() {
  ...
  // ── tips auto-rotate (images do NOT auto-rotate — click only) ──
  useEffect(function() {
    var t = setInterval(function() { setTipIndex(function(p) { return (p + 1) % TIPS.length; }); }, 8000);
  ...
  var showMobile = isMobile && !desktopMode;
  ...
  return (
    <div style={{ fontFamily: "sans-serif", minHeight: "100vh" }}>
      ...
      {/* ── Desktop View Toggle (mobile only) ── */}
      {isMobile && (
        <div style={{ position: "fixed", bottom: 20, right: 16, zIndex: 9999 }}>
          <button onClick={function() { setDesktopMode(function(d) { return !d; }); }}
            style={{ padding: "10px 16px", background: desktopMode ? "linear-gradient(135deg,#f5576c,#f093fb)" : "linear-gradient(135deg,#667eea,#764ba2)", color: "white", border: "none", borderRadius: 99, fontSize: 12, fontWeight: 800, cursor: "pointer", boxShadow: "0 4px 20px rgba(0,0,0,0.3)", display: "flex", alignItems: "center", gap: 6 }}>
            {desktopMode ? "📱 Mobile View" : "🖥️ Desktop View"}
          </button>
        </div>
      )}

      {/* ── NAVBAR ── */}
      <nav style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: showMobile ? "14px 16px" : "18px 48px", position: "fixed", top: 0, left: 0, right: 0, zIndex: 50, background: page === "home" ? "rgba(15,23,42,0.9)" : "white", backdropFilter: "blur(14px)", borderBottom: page === "home" ? "1px solid rgba(255,255,255,0.08)" : "1px solid #eee" }}>
        <div onClick={function() { setPage("home"); }} style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer" }}>
          ...
          <span style={{ fontSize: showMobile ? 16 : 20, fontWeight: 900, color: page === "home" ? "white" : "#0f172a" }}>ProTrack</span>
        </div>
        {!showMobile && (
        ...
        <div style={{ display: "flex", gap: showMobile ? 6 : 10 }}>
          <button onClick={function() { switchMode("login"); setShowForm(true); }} style={{ padding: showMobile ? "8px 14px" : "9px 22px", background: "transparent", cursor: "pointer", color: page === "home" ? "white" : "#667eea", border: "2px solid " + (page === "home" ? "rgba(255,255,255,0.4)" : "#667eea"), borderRadius: 10, fontSize: showMobile ? 13 : 14, fontWeight: 700 }}>Log In</button>
          <button onClick={function() { switchMode("signup"); setShowForm(true); }} style={{ padding: showMobile ? "8px 14px" : "9px 22px", background: "linear-gradient(135deg,#667eea,#764ba2)", color: "white", border: "none", borderRadius: 10, fontSize: showMobile ? 13 : 14, fontWeight: 700, cursor: "pointer" }}>Sign Up</button>
        </div>
      </nav>
      ...
      {page === "home" && (
        <div style={{ minHeight: "100vh", background: "linear-gradient(135deg,#0f172a 0%,#1e3a5f 100%)", paddingTop: showMobile ? 62 : 74, overflow: "hidden", position: "relative" }}>
          <div style={{ position: "absolute", width: 400, height: 400, borderRadius: "50%", background: "rgba(102,126,234,0.06)", top: -100, left: -100, pointerEvents: "none" }} />

          {showMobile ? (
            // ── MOBILE LAYOUT ──
            <div style={{ padding: "28px 20px 100px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "rgba(102,126,234,0.2)", borderRadius: 99, padding: "6px 14px", marginBottom: 18, border: "1px solid rgba(102,126,234,0.3)" }}>
                <span style={{ color: "#a5b4fc", fontSize: 11, fontWeight: 600 }}>💼 For IT · Managers · Freelancers · All Pros</span>
              </div>
              <h1 style={{ color: "white", fontSize: 36, fontWeight: 900, lineHeight: 1.1, margin: "0 0 16px", letterSpacing: "-1px" }}>Work Smarter,<br />Deliver Faster!</h1>
              <p style={{ color: "rgba(255,255,255,0.65)", fontSize: 15, lineHeight: 1.7, marginBottom: 20 }}>Track projects, skills, goals and deadlines. Smart alarms, Focus Mode and more.</p>
              <div style={{ background: "rgba(102,126,234,0.15)", borderRadius: 12, padding: "14px 16px", marginBottom: 22, borderLeft: "4px solid #667eea" }}>
                <p style={{ color: "rgba(255,255,255,0.85)", fontSize: 13, fontStyle: "italic", margin: "0 0 4px" }}>"The key is not to prioritize what's on your schedule, but to schedule your priorities."</p>
                <p style={{ color: "rgba(255,255,255,0.4)", fontSize: 11, margin: 0 }}>— Stephen Covey</p>
              </div>
              <div style={{ display: "flex", gap: 10, marginBottom: 28 }}>
                <button onClick={function() { switchMode("signup"); setShowForm(true); }} style={{ flex: 1, padding: "14px 0", background: "linear-gradient(135deg,#667eea,#764ba2)", color: "white", border: "none", borderRadius: 12, fontSize: 15, fontWeight: 800, cursor: "pointer" }}>Get Started →</button>
                <button onClick={function() { setPage("features"); }} style={{ flex: 1, padding: "14px 0", background: "rgba(255,255,255,0.06)", color: "white", border: "2px solid rgba(255,255,255,0.15)", borderRadius: 12, fontSize: 15, fontWeight: 700, cursor: "pointer" }}>See Features</button>
              </div>

              {/* Mobile image — click only */}
              <div style={{ borderRadius: 18, overflow: "hidden", boxShadow: "0 12px 40px rgba(0,0,0,0.4)", position: "relative", marginBottom: 16 }}>
                <img src={currentImg.url} alt="work" style={{ width: "100%", height: 180, objectFit: "cover", display: "block" }} />
                <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, background: "linear-gradient(transparent,rgba(0,0,0,0.7))", padding: "20px 14px 12px" }}>
                  <p style={{ color: "white", fontSize: 13, fontWeight: 700, margin: 0 }}>{currentImg.caption}</p>
                </div>
                {/* Click arrows */}
                <button onClick={function() { setImgIndex(function(p) { return (p - 1 + IMAGES.length) % IMAGES.length; }); }}
                  style={{ position: "absolute", left: 10, top: "50%", transform: "translateY(-50%)", width: 36, height: 36, borderRadius: "50%", background: "rgba(0,0,0,0.5)", border: "none", color: "white", fontSize: 18, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700 }}>‹</button>
                <button onClick={function() { setImgIndex(function(p) { return (p + 1) % IMAGES.length; }); }}
                  style={{ position: "absolute", right: 10, top: "50%", transform: "translateY(-50%)", width: 36, height: 36, borderRadius: "50%", background: "rgba(0,0,0,0.5)", border: "none", color: "white", fontSize: 18, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700 }}>›</button>
                <div style={{ position: "absolute", top: 10, right: 10, display: "flex", gap: 5 }}>
                  {IMAGES.map(function(_, i) { return <div key={i} onClick={function() { setImgIndex(i); }} style={{ width: i === imgIndex ? 16 : 6, height: 6, borderRadius: 99, background: i === imgIndex ? "white" : "rgba(255,255,255,0.4)", cursor: "pointer", transition: "all 0.3s" }} />; })}
                </div>
              </div>

              {/* Pro Tips mobile */}
              <div style={{ background: "rgba(102,126,234,0.12)", borderRadius: 18, padding: "16px 18px", border: "1px solid rgba(102,126,234,0.25)", marginBottom: 20 }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <span style={{ fontSize: 20 }}>{currentTip.icon}</span>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10 }}>
                {[["⏰","Smart Alarms","todo"],["⏱️","Focus Mode","focus"],["📝","To-Do List","todo"]].map(function(item) {
                  return (
                    <div key={item[1]} onClick={function() { setRedirectTo(item[2]); switchMode("login"); setShowForm(true); }}
                      style={{ background: "rgba(255,255,255,0.07)", borderRadius: 14, padding: "14px 10px", textAlign: "center", cursor: "pointer", border: "1px solid rgba(255,255,255,0.1)", transition: "all .2s" }}
                      onMouseEnter={function(e) { e.currentTarget.style.background = "rgba(102,126,234,0.2)"; }}
                      onMouseLeave={function(e) { e.currentTarget.style.background = "rgba(255,255,255,0.07)"; }}>
                      <p style={{ fontSize: 22, margin: "0 0 6px" }}>{item[0]}</p>
                      <p style={{ color: "white", fontSize: 11, fontWeight: 700, margin: 0 }}>{item[1]}</p>
                    </div>
                  );
                })}
              </div>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "50px 64px 0", position: "relative", zIndex: 2, gap: 40, flexWrap: "wrap" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16, width: 360, flexShrink: 0 }}>
                {/* Desktop image — click only, arrows on hover */}
      ...
      {showForm && (
        <div onClick={function() { setShowForm(false); }} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.6)", zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
          <div onClick={function(e) { e.stopPropagation(); }} style={{ background: "white", borderRadius: 24, padding: showMobile ? 24 : 36, width: "100%", maxWidth: 400, boxShadow: "0 24px 64px rgba(0,0,0,0.4)", maxHeight: "95vh", overflowY: "auto" }}>
            <div style={{ textAlign: "center", marginBottom: 20 }}>
              <div style={{ width: 48, height: 48, borderRadius: 14, background: "linear-gradient(135deg,#667eea,#764ba2)", margin: "0 auto 10px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24 }}>💼</div>
              <h2 style={{ margin: "0 0 4px", fontSize: 20 }}>{mode === "login" ? "Welcome Back!" : "Create Account"}</h2>
